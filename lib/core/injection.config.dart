...
import 'package:alias/feature/game/domain/usecases/get_unfinished_game.dart'
    as _i27;
import 'package:alias/feature/game/domain/usecases/load_words.dart' as _i28;
...
import 'package:alias/feature/game/domain/usecases/save_played_words.dart'
    as _i30;
import 'package:alias/feature/game/domain/words_usecases_facade.dart' as _i31;
import 'package:alias/feature/game/presentation/bloc/game_bloc.dart' as _i32;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i24.CategoriesBloc>(
        () => _i24.CategoriesBloc(loadCategories: gh<_i15.LoadCategories>()));
    gh.factory<_i25.CommandsBloc>(
        () => _i25.CommandsBloc(loadCommandsUseCase: gh<_i16.LoadCommands>()));
    gh.factory<_i26.GetPlayedWords>(
        () => _i26.GetPlayedWords(repository: gh<_i22.WordsRepository>()));
    gh.factory<_i27.GetUnfinishedGame>(
        () => _i27.GetUnfinishedGame(repository: gh<_i22.WordsRepository>()));
    gh.factory<_i28.LoadWords>(
        () => _i28.LoadWords(repository: gh<_i22.WordsRepository>()));
    gh.factory<_i29.ResetGameHistory>(
        () => _i29.ResetGameHistory(repository: gh<_i22.WordsRepository>()));
    gh.factory<_i30.SavePlayedWords>(
        () => _i30.SavePlayedWords(repository: gh<_i22.WordsRepository>()));
    gh.factory<_i31.WordsUseCasesFacade>(() => _i31.WordsUseCasesFacade(
          loadWords: gh<_i28.LoadWords>(),
          savePlayedWords: gh<_i30.SavePlayedWords>(),
          getPlayedWords: gh<_i26.GetPlayedWords>(),
          resetGameHistory: gh<_i29.ResetGameHistory>(),
          getUnfinishedGame: gh<_i27.GetUnfinishedGame>(),
        ));
    gh.factory<_i32.GameBloc>(() =>
        _i32.GameBloc(wordsUseCasesFacade: gh<_i31.WordsUseCasesFacade>()));
    return this;
  }
}
