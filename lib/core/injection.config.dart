...
import 'package:alias/feature/game/presentation/bloc/game_bloc.dart' as _i33;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i16.GetPlayedWords>(
        () => _i16.GetPlayedWords(repository: gh<_i17.WordsRepository>()));
    gh.factory<_i18.GetUnfinishedGame>(
        () => _i18.GetUnfinishedGame(repository: gh<_i17.WordsRepository>()));
    gh.factory<_i19.LoadCategories>(
        () => _i19.LoadCategories(repository: gh<_i7.CategoryRepository>()));
    gh.factory<_i20.LoadCommands>(
        () => _i20.LoadCommands(repository: gh<_i11.CommandsRepository>()));
    gh.factory<_i21.LoadWords>(
        () => _i21.LoadWords(repository: gh<_i17.WordsRepository>()));
    gh.factory<_i22.ResetGameHistory>(
        () => _i22.ResetGameHistory(repository: gh<_i17.WordsRepository>()));
    gh.factory<_i23.SavePlayedWords>(
        () => _i23.SavePlayedWords(repository: gh<_i17.WordsRepository>()));
    gh.factory<_i24.SaveStartedGame>(
        () => _i24.SaveStartedGame(repository: gh<_i17.WordsRepository>()));
    ...
    gh.factory<_i30.WordsUseCasesFacade>(() => _i30.WordsUseCasesFacade(
          loadWords: gh<_i21.LoadWords>(),
          savePlayedWords: gh<_i23.SavePlayedWords>(),
          getPlayedWords: gh<_i16.GetPlayedWords>(),
          resetGameHistory: gh<_i22.ResetGameHistory>(),
          getUnfinishedGame: gh<_i18.GetUnfinishedGame>(),
        ));
    gh.factory<_i31.CategoriesBloc>(
        () => _i31.CategoriesBloc(loadCategories: gh<_i19.LoadCategories>()));
    gh.factory<_i32.CommandsBloc>(
        () => _i32.CommandsBloc(loadCommandsUseCase: gh<_i20.LoadCommands>()));
    gh.factory<_i33.GameBloc>(() =>
        _i33.GameBloc(wordsUseCasesFacade: gh<_i30.WordsUseCasesFacade>()));
    return this;
  }
}
