...
mixin _$GameEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CommandDto> commands) initializeCommands,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CommandDto> commands)? initializeCommands,
...
abstract class _$$_InitializeCommandsCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CommandDto> commands});
}
...
class _$_InitializeCommands implements _InitializeCommands {
  const _$_InitializeCommands({required final List<CommandDto> commands})
      : _commands = commands;

  final List<CommandDto> _commands;
  @override
  List<CommandDto> get commands {
...
abstract class _InitializeCommands implements GameEvent {
  const factory _InitializeCommands(
      {required final List<CommandDto> commands}) = _$_InitializeCommands;
...
mixin _$GameState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            GameSettings settings, List<PlayingCommand> commands)
        gameIsReady,
...
abstract class _$$_GameIsReadyCopyWith<$Res> {
  ...
  @useResult
  $Res call({GameSettings settings, List<PlayingCommand> commands});
}
...
class _$_GameIsReady implements _GameIsReady {
  const _$_GameIsReady(
      {required this.settings, required final List<PlayingCommand> commands})
      : _commands = commands;
  ...
  @override
  String toString() {
    return 'GameState.gameIsReady(settings: $settings, commands: $commands)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, settings, const DeepCollectionEquality().hash(_commands));
  ...
  TResult when<TResult extends Object?>({
    ...
    return gameIsReady(settings, commands);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return gameIsReady?.call(settings, commands);
  }
...
abstract class _GameIsReady implements GameState {
  const factory _GameIsReady(
      ...
      required final List<PlayingCommand> commands}) = _$_GameIsReady;
